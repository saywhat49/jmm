...
$jtable_theme = $params->get('jtable_theme', 'lightcolor');

// Définir les constantes au lieu de les utiliser directement
$ds = DIRECTORY_SEPARATOR;

// Charger les ressources nécessaires
$document->addStyleSheet($this->curThemeURL . '/jtable/themes' . $ds . $jtable_theme);
...
$no_record_per_page = (int) $params->get('no_record_per_page', 10);

// Préparer les champs pour jTable
$fields = array();

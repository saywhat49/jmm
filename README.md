...
Download Latest Zip File From here https://github.com/saywhat49/jmm . Login to your joomla administrator panel go to Extension Manger from Extensions Menu then click on Select or Browse File Icon select your recently downloaded JMM Zip File. Then Click on Install.After successfull installation Click on component Menu you can see Joomla Mysql Manager Menu click here and start JMM. 
...
* You can select theme or step further by customize the looks using css and javascript or jquery.

### Authors and Contributors
@adidac Biswarup Adhikari. Fork by saywhat49
Rebuild completly @saywhat49.

### Support or Contact

For any Problem, Bugs, Feedback you can look on Github.

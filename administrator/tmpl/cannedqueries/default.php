...
?>
<form action="<?php echo Route::_('index.php?option=com_jmm&view=cannedqueries'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                            ...
                            <?php if (!empty($this->items)): ?>
                                <?php foreach ($this->items as $i => $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo Route::_('index.php?option=com_jmm&task=cannedquery.edit&id=' . (int) $item->id); ?>" class="fw-bold text-decoration-none">
                                        ...
                                        <td class="text-center">
                                            <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'cannedqueries.', true, 'cb'); ?>
                                        </td>
                                        <td class="text-end">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-4">
                                        <?php echo Text::_('COM_JMM_NO_CANNED_QUERIES_FOUND'); ?>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>

...
ALTER TABLE `#__jmm_templates` ADD COLUMN IF NOT EXISTS `layout_type` varchar(20) NOT NULL DEFAULT 'table' AFTER `title`;
ALTER TABLE `#__jmm_templates` ADD COLUMN IF NOT EXISTS `chart_type` varchar(20) NOT NULL DEFAULT 'PieChart' AFTER `layout_type`;
ALTER TABLE `#__jmm_templates` ADD COLUMN IF NOT EXISTS `custom_css` text DEFAULT NULL AFTER `chart_type`;
